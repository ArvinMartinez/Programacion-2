...
public class DatosdePrueba
{
    ...
    private void cargarProductos()
    {
        ...
        Producto p4 = new Producto(4, "Impresora Hp", 2875);
        ListadeProductos.Add(p4);

        Producto p5 = new Producto(5, "consola de video juegos PlayStation 5 ", 4749);
    ...
    {
        Cliente c1 = new Cliente(1, "Imer brock", "1618-1984-00253");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "Jose Murillo", "1407-2008-00106");
        ListadeClientes.Add(c2);

        Cliente c3 = new Cliente(3, "Rafael Murillo", "0512-1985-01596");
        ListadeClientes.Add(c3);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Francisco Mendoza", "V0001");
